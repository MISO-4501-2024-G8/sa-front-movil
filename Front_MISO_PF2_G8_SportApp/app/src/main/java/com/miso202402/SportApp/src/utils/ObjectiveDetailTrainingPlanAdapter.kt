...
class ObjectiveDetailTrainingPlanAdapter (
    private val objectiveList:  List<Objective> ) : RecyclerView.Adapter<ObjectiveDetailTrainingPlanAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.objective_week_item, viewGroup, false)
